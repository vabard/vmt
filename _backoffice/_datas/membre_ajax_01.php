...
if ($_POST['id'] == -2) {
    ...
    while($extract = $rqselect -> fetch(PDO::FETCH_ASSOC)){
        ...
        $tab['liste'] .= '<div class="divtable"><a class="" onclick="listemembre(' . $extract['id_membre'] . ', ' . '1' . ')"">';
        ...
        $tab['liste'] .= '<a class="" onclick="listemembre(' . $extract['id_membre'] . ', ' . '2' . ')""><div class="divchamp" style="width:10%;"><i class="fa fa-remove fa-1x"></i></div></a>';
        $tab['liste'] .= '</div>';
        ...
        // $tab['liste'] .= '</a>';
        // $tab['liste'] .= '<a class="app_btn" style="width:10%;" onclick="listemembre(' . $extract['id_membre'] . ', ' . '1' . ')""><i class="fa fa-pencil-square fa-1x"></i></a>';
        // $tab['liste'] .= '<a class="app_btn" style="width:10%;" onclick="listemembre(' . $extract['id_membre'] . ', ' . '2' . ')""><i class="fa fa-remove fa-1x"></i></a>';
        // $tab['liste'] .= '<div class="clear"></div>';
        }
