...
<section class="app_container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="app_blok">
          	<h3>liste des  salle :</h3>
        	<div id="listesalle" class="app_blok_scroll"></div>
        </div>
    </div>
</section>
<section class="app_container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="app_blok">
            ...
            <form method="post" action="">
                ...
                <div class="app_btn" style="width:50%;"><a href="salle.php">raz du formulaire</a></div>
                <div class="clear"></div>
            </form>
            </div>
        </div>
...
<script>
    ...
    window.addEventListener("load", listesalle(-1,0));
