...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 16 nov. 2017 à 15:38
...
INSERT INTO `salle` (`id_salle`, `titre`, `description`, `pays`, `ville`, `adresse`, `cp`, `capacite`, `categorie`) VALUES
(1, 'Cézanne', 'Avec une capacité de 15 personnes, la salle de réunion Cézanne est idéale pour vos rendez-vous d\'affaires. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Paris', '3 allée des impressionnistes', 75001, 15, 'reunion'),
(2, 'Van Gogh', 'Avec une capacité de 20 personnes, la salle Van Gogh est idéale pour vos sessions de formation. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Paris', '30 rue Mademoiselle', 75007, 20, 'formation'),
(3, 'Picasso', 'Avec une capacité de 10 personnes, notre bureau Picasso, clair et spacieux pourra vous permettre de travailler au calme dans un espace atypique au centre de Paris.. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Paris', '17 rue de Turbigo', 75002, 10, 'bureau'),
(4, 'Mozart', 'Avec une capacité de 15 personnes, la salle de réunion Mozart est idéale pour vos rendez-vous d\'affaires. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Lyon', '3 allée des impressionnistes', 69001, 15, 'reunion'),
(5, 'Bach', 'Avec une capacité de 20 personnes, la salle Bach est idéale pour vos sessions de formation. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Lyon', '30 rue Mademoiselle', 69007, 20, 'formation'),
(6, 'Satie', 'Avec une capacité de 10 personnes, notre bureau Satie, clair et spacieux pourra vous permettre de travailler au calme dans un espace atypique au centre de Lyon.. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Lyon', '17 rue de Turbigo', 69002, 10, 'bureau'),
(7, 'Rodin', 'Avec une capacité de 15 personnes, la salle de réunion Rodin est idéale pour vos rendez-vous d\'affaires. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Marseille', '3 allée des impressionnistes', 13001, 15, 'reunion'),
(8, 'Claudel', 'Avec une capacité de 20 personnes, la salle Claudel est idéale pour vos sessions de formation. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Marseille', '30 rue Mademoiselle', 13007, 20, 'formation'),
(9, 'Maillol', 'Avec une capacité de 10 personnes, notre bureau Maillol, clair et spacieux pourra vous permettre de travailler au calme dans un espace atypique au centre de Lyon.. Connexion Wifi, écran LED, paperboard et café ou thé sont mis à votre disposition.', 'France', 'Marseille', '17 rue de Turbigo', 13002, 10, 'bureau');
...
--
ALTER TABLE `salle`
  MODIFY `id_salle` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
